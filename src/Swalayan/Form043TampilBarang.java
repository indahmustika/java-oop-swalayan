...
public class Form043TampilBarang extends javax.swing.JFrame {

    public Form043TampilBarang() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbBack.setText("MyMart - Data Barang");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(21, 21, 21)
                .addComponent(lbBack, javax.swing.GroupLayout.DEFAULT_SIZE, 498, Short.MAX_VALUE)
                .addGap(46, 46, 46)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form043TampilBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form043TampilBarang().setVisible(true);
            }
        });
    }
